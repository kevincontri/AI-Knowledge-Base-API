...
class NoteRepositoryMock:
    ...
    async def create_note(self, title: str, content: str, user_id: int):
        return {"id": 1, "title": title, "content": content, "user_id": user_id, "created_at": "2023-01-01"}
    
    async def get_note_by_id(self, note_id: int):
        return {"id": 1, "title": "Title Test", "content": "Content Test", "user_id": 1, "created_at": "2023-01-01"}
    
    async def get_all_notes(self):
        return [{"id": 1, "title": "Title Test", "content": "Content Test", "user_id": 1, "created_at": "2023-01-01"}]
    
    async def update_note(self, note_id: int, title: str = None, content: str = None):
        return {"id": 1, "title": title, "content": content, "user_id": 1, "created_at": "2023-01-01"}
